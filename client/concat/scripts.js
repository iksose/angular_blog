...
angular.module('uiRouterSample', ['ui.router', 'ngAnimate', 'ngResource', 'ui.bootstrap', 'chieffancypants.loadingBar', 'textAngular']).run(['$rootScope', '$state', '$stateParams', function($rootScope, $state, $stateParams) {
